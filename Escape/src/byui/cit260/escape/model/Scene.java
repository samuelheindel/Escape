...
public enum Scene implements Serializable {
    ...
    palmtree("Here are palmtrees they can be used to make logs, you can also get coconuts and logs from them","PT"),
    ...
    ferns("This area contains ferns. They are used to make rope","FR"),
